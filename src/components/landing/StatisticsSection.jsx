    ...
    <section className="px-36 bg-gray-900 text-gray-600 body-font">
        ...
        <section className="bg-white dark:bg-gray-900">
            ...
            <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
                ...
                <RiTeamLine className='text-blue-700 w-12 h-12 mb-3 inline-block' />
            ...
            <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
                <div className="border-2 border-gray-700 px-4 py-6 rounded-lg">
                <PiStudentBold className='text-blue-700 w-12 h-12 mb-3 inline-block'/>
            ...
            <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
                ...
                <PiChalkboardTeacher className='text-blue-700 w-12 h-12 mb-3 inline-block'/>
            ...
            <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
                <div className="border-2 border-gray-700 px-4 py-6 rounded-lg">
                <LuSchool className='text-blue-700 w-12 h-12 mb-3 inline-block'/>
