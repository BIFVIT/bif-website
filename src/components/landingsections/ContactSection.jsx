...
const ContactSection = () => {
  ...
  ${name}`;
    ...
    const mailtoLink = `mailto:${sendToEmail}?subject=${emailSubject}&body=${encodeURIComponent(
      emailContent
    )}`;
  ...
  return (
    <section
      id="contact"
      className="bg-background px-4 lg:px-36 text-gray-400 dark:bg-darkbackground body-font relative"
    >
      <h2 className="mb-4 text-4xl text-center tracking-tight font-extrabold text-primary dark:text-darkprimary">
        Contact Us
      </h2>
      <p className="mb-8 lg:mb-16 font-light text-center text-text dark:text-darktext dark:opacity-90 sm:text-xl">
        Seeking information about our collaboration opportunities? Looking to
        Volunteer with Us? Talk to us.
      </p>
        ...
        <div className="lg:w-2/3 md:w-1/2 bg-gray-500 border-2 border-primary dark:border-darkprimary border-opacity-50 dark:bg-darkbackground rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
          ...
          <div className="bg-secondary dark:bg-darkbackground relative flex flex-wrap py-6 rounded shadow-md">
            <div className="lg:w-1/2 px-6">
              <h2 className="title-font font-semibold text-gray-800 dark:text-darktext tracking-widest text-xs">
                ADDRESS
              </h2>
              <p className="text-text dark:text-darktext dark:opacity-80 mt-1">
                VIT, Vellore Campus, Tiruvalam Rd, Katpadi, Vellore, Tamil Nadu
                632014, India
              </p>
            </div>
            <div className="lg:w-1/2 px-6 mt-4 lg:mt-0">
              ...
              <h2 className="title-font font-semibold text-gray-800 dark:text-darktext tracking-widest text-xs mt-4">
                PHONE
              </h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div>
              ...
              >
                ...
                <option value="School">
                  We are a School who want to collaborate
                </option>
                <option value="Brand">
                  We are a brand looking to collaborate
                </option>
            ...
            <div className="flex items-center">
              ...
              <label
                ...
                className="ml-2 text-sm font-medium text-text dark:text-darktext"
              >
                By submitting this form, you confirm that you have read and
                agree to our{" "}
                <a
                  href="#"
                  className="text-primary dark:text-darkprimary hover:underline"
                >
                  Terms & Conditions
                </a>
                .
