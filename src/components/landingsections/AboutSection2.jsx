            ...
            <div className="w-full px-4 lg:w-6/12">
              ...
              <div className="w-full px-3 sm:px-4 xl:w-1/2">
                  <div className="relative z-10 my-4">
                    ...
                    />
                    <span className="absolute -left-7 -bottom-7 z-[-1] hover:scale-110 transition duration-500 cursor-pointer object-cover">
                      <svg
                        width={134}
                        height={106}
                        viewBox="0 0 134 106"
                      ...
                      >
                        <circle
                          ...
                          className="fill-primary dark:fill-darkprimary"
                        />
                        <circle
                          cx="16.3333"
                          cy={104}
