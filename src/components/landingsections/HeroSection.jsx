  ...
  return (
    <section class="bg-background dark:bg-darkbackground">
        <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
            ...
            <a href="#" target='_blank' class="inline-flex justify-between items-center py-1 px-1 pr-4 mb-7 text-sm text-gray-700  rounded-full bg-secondary dark:bg-darksecondary dark:text-darktext hover:bg-highlight dark:hover:bg-darkhighlight" role="alert">
                <span class="text-xs bg-primary dark:bg-darkprimary   rounded-full text-darktext px-4 py-1.5 mr-3">New</span> <span class="text-sm font-medium">Blog released! Read on Medium</span> 
                ...
                <a href="#" class="mr-4 mb-4 bg-secondary dark:bg-darksecondary hover:-translate-y-1 dark:hover:bg-darkhighlight inline-flex items-center justify-center px-5 py-3 text-base font-medium text-center text-white rounded-lg dark:text-darktext ">
                    Learn More
                </a> 
