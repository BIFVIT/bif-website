...
const Navbar = () => {
    return (
        ...
        <div class="flex items-center md:order-2">
            <button type="button" data-dropdown-toggle="language-dropdown-menu" class="inline-flex items-center font-medium justify-center px-4 py-2 text-sm text-text dark:text-darktext rounded-lg cursor-pointer hover:bg-purple-300 dark:hover:bg-gray-700 dark:hover:text-white">
            ...
            <div class="z-50 hidden my-4 text-base list-none bg-background divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700" id="language-dropdown-menu">
        ...
        <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-language">
            ...
            <li>
                <a href="#" class="block py-2 pl-3 pr-4 text-text rounded md:hover:bg-transparent md:hover:text-primary md:p-0 dark:text-darktext md:dark:hover:text-darkprimary dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Blog</a>
            </li>
            <li>
