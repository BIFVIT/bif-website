...
const Navbar = () => {
    ...
    return (
        ...
        <div class="flex items-center md:order-2">
            <button type="button"   onClick={toggleDropdown} data-dropdown-toggle="language-dropdown-menu" class="inline-flex items-center font-medium justify-center px-4 py-2 text-sm text-text dark:text-darktext rounded-lg cursor-pointer hover:bg-highlight dark:hover:bg-darkhighlight dark:hover:text-white">
            ...
            <button data-collapse-toggle="navbar-language" type="button" class="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-text dark:text-darktext rounded-lg md:hidden hover:bg-purple-300 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" aria-controls="navbar-language" aria-expanded="false">
        ...
        <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-language">
            ...
            <li>
                <a href="#" class="block py-2 pl-3 pr-4 text-text rounded md:hover:bg-transparent md:hover:text-primary md:p-0 dark:text-darktext md:dark:hover:text-darkprimary dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Events</a>
            </li>
            <li>
                <a href="#" class="block py-2 pl-3 pr-4 text-text rounded md:hover:bg-transparent md:hover:text-primary md:p-0 dark:text-darktext md:dark:hover:text-darkprimary dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Team</a>
            </li>
            </ul>
        </div>
        </div>
