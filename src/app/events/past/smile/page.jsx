...
const eventData = {
  ...
  eventtitle: "Smile",
  viewtype: "Riviera Flagship Event",
  keyinfo: [
    {
      time: "7-12 AM",
  ...
  description:
    "We orchestrated a day filled with joy and entertainment for underprivileged children in Vellore. From lively music and engaging games to delightful comedy and vibrant dance performances, we infused the event with laughter and happiness, crafting unforgettable moments for the children from government schools. This heartwarming gathering served as a poignant reminder that even a small act of kindness, combined with a generous dose of fun, and the collective support of our community, has the power to illuminate lives and leave enduring smiles on the faces of the youth involved.",
  childImgs: [
